...
public class java {
	...
	public tatlilar() {
		...
		JButton btnIecekler = new JButton("PARFE");
		btnIecekler.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			veriekle("PARFE",6);
			dlm.addElement("PARFE");
			}
		});
		...
		JButton btnAparatifler = new JButton("KÜNEFE");
		btnAparatifler.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			veriekle("KUNEFE",9);
			dlm.addElement("KUNEFE");
			}
		});
		...
		JButton btnNargileler = new JButton("DONDURMA");
		btnNargileler.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			veriekle("DONDURMA",5);
			dlm.addElement("DONDURMA");
			}
		});
