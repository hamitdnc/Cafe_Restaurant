...
public class sicak extends JFrame {
...
public class java {
	...
	public sicak() {
		...
		JButton btnNewButton = new JButton("CAY");
		...
		JButton btnIecekler = new JButton("KAHVE");
		btnIecekler.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			veriekle("KAHVE",6);
			dlm.addElement("KAHVE");
			}
		});
		...
		JButton btnAparatifler = new JButton("SICAK CIKOLATA");
		btnAparatifler.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			veriekle("SICAK CIKOLATA",7);
			dlm.addElement("SICAK CIKOLATA");	
			}
		});
		...
		JButton btnNargileler = new JButton("BÝTKÝ ÇAYI");
		btnNargileler.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			veriekle("BITKI CAYI",3);
			dlm.addElement("BITKI CAYI");	
			}
		});
		...
		JButton btnSigaralar = new JButton("CAPPUCÝNO");
		btnSigaralar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			veriekle("CAPPUCINO",8);
			dlm.addElement("CAPPUCINO");	
			}
		});
