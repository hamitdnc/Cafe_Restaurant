...
public class soguk extends JFrame {
...
public class java {
	...
	public soguk() {
		...
		JButton btnNewButton = new JButton("SU");
		...
		JButton btnIecekler = new JButton("COLA");
		...
		JButton btnAparatifler = new JButton("PEPSÝ");
		btnAparatifler.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			veriekle("PEPSI",4);
			dlm.addElement("PEPSI");
			}
		});
		...
		JButton btnNargileler = new JButton("MEYVE SUYU");
		btnNargileler.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			veriekle("MEYVE SUYU",3);
			dlm.addElement("MEYVE SUYU");
			}
		});
		...
		JButton btnSigaralar = new JButton("CHOCOFREDO");
		btnSigaralar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			veriekle("CHOCOFREDO",8);
			dlm.addElement("CHOCOFREDO");
			}
		});
		...
		JButton btnTatllar = new JButton("SODA");
		...
		JButton btnBurgerler = new JButton("LÝMONATA");
		btnBurgerler.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			veriekle("LIMONATA",30);
			dlm.addElement("LIMONATA");	
			}
		});
		btnBurgerler.setBackground(new Color(250, 250, 150));
