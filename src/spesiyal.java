...
public class spesiyal extends JFrame {
...
public class java {
	...
	public spesiyal() {
		...
		JButton btnNewButton = new JButton("MUZLU SUT");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			veriekle("MUZLU SUT",2);
			dlm.addElement("MUZLU SUT");
			}
		});
		...
		JButton btnIecekler = new JButton("ATOM");
