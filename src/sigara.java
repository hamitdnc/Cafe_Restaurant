...
public class sigara extends JFrame {
...
public class java {
	...
	public sigara() {
		...
		JButton btnNewButton = new JButton("PARLIAMENT");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			veriekle("PARLIAMENT",10);
			dlm.addElement("PARLIAMENT");
			}
		});
		...
		JButton btnIecekler = new JButton("MARLBORO");
		btnIecekler.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			veriekle("MARLBORO",11);
			dlm.addElement("MARLBORO");	
			}
		});
